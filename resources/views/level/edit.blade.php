            ...
            @else
                <form method="POST" action="{{ url('/level/'.$user->level_id) }}" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="level_kode" name="level_kode" value="{{ old('level_kode', $user->level_kode) }}" required>
                            @error('level_kode')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="text" class="form-control" id="level_nama" name="level_nama" value="{{ old('level_nama', $user->level_nama) }}" required>
                            @error('level_nama')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
