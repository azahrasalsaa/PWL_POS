...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ url('/kategori/'.$kategori->kategori_id) }}" class="form-horizontal">
            @csrf
            @method('PUT') <!-- This directive simplifies the syntax for including a hidden input for PUT methods -->
...
@push('css')
<!-- Push additional CSS files or styles here -->
@endpush

@push('js')
<!-- Push additional JS files or scripts here -->
@endpush